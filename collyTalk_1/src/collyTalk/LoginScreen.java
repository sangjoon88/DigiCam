...
public class LoginScreen extends JFrame {
    ...
    public LoginScreen() {
        ...
        registerButton.setPreferredSize(new Dimension(150, 30)); // 회원가입 버튼의 크기 설정
        gbc.gridx = 0;
        gbc.gridy = 3;
        gbc.gridwidth = 2;
        ...
        adminLoginButton.setFont(new Font("@나눔스퀘어라운드", Font.BOLD, 16)); // 글꼴 크기 조정
        adminLoginButton.setPreferredSize(new Dimension(150, 30)); // 관리자 로그인 버튼의 크기 설정
        gbc.gridx = 0;
        gbc.gridy = 4;
        gbc.gridwidth = 2;
